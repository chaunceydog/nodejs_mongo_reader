...
console.log("In setup_tests after new stormpath.Client");
...
setupTasksArray = [
    ...
    function closeDB(callback) {
        console.log("in setup_tests.js - about to reader_db.close");
        reader_db.close();
    },
...
console.log("In setup_tests - call async.series ");
